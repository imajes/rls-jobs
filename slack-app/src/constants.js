...
const CHANNEL_FOCUS_OPTIONS = [
  { value: CHANNEL_FOCUS.JOBS, text: '#jobs' },
...
const WORK_ARRANGEMENT_OPTIONS = [
  ...
  { value: WORK_ARRANGEMENT.FLEXIBLE, text: 'Flexible or mixed' },
];
...
const EMPLOYMENT_TYPE_OPTIONS = [
  ...
  { value: EMPLOYMENT_TYPE.COFOUNDER, text: 'Cofounder or founding role' },
];
...
const CANDIDATE_AVAILABILITY_OPTIONS = [
  ...
  { value: CANDIDATE_AVAILABILITY.CONTRACT_ONLY, text: 'Contract or consulting only' },
...
const COMP_DISCLOSURE_OPTIONS = [
  ...
  { value: COMP_DISCLOSURE.NEGOTIABLE, text: 'Negotiable or TBD' },
  { value: COMP_DISCLOSURE.NOT_LISTED, text: 'Not listed' },
  { value: COMP_DISCLOSURE.PERFORMANCE_BASED, text: 'Commission or variable' },
];

const COMP_COMPONENT_OPTIONS = [
  { value: COMP_COMPONENT.EQUITY, text: 'Equity' },
  { value: COMP_COMPONENT.BONUS, text: 'Bonus' },
  { value: COMP_COMPONENT.COMMISSION, text: 'Commission' },
];

const RELATIONSHIP_OPTIONS_JOB = [
  { value: POSTER_RELATIONSHIP.HIRING_MANAGER, text: 'Hiring manager' },
  { value: POSTER_RELATIONSHIP.TEAM_MEMBER, text: 'Team member' },
  { value: POSTER_RELATIONSHIP.RECRUITER, text: 'Recruiter' },
  { value: POSTER_RELATIONSHIP.REFERRAL, text: 'Can refer or introduce' },
...
const RELATIONSHIP_OPTIONS_CANDIDATE = [
  ...
  { value: POSTER_RELATIONSHIP.RECRUITER, text: 'Recruiter or sourcer' },
  { value: POSTER_RELATIONSHIP.OTHER, text: 'Other' },
];

const VISA_POLICY_OPTIONS_JOB = [
  ...
  { value: VISA_POLICY.UNKNOWN, text: 'Unknown' },
];

const VISA_POLICY_OPTIONS_CANDIDATE = [
  { value: VISA_POLICY.NO, text: 'Authorized, no sponsorship needed' },
  { value: VISA_POLICY.YES, text: 'Will require sponsorship' },
  { value: VISA_POLICY.CASE_BY_CASE, text: 'Case-by-case' },
  { value: VISA_POLICY.UNKNOWN, text: 'Prefer not to say' },
];

function mapByValue(options) {
  return Object.fromEntries(options.map((option) => [option.value, option.text]));
}
...
module.exports = {
  ...
  labels: {
    candidateAvailability: mapByValue(CANDIDATE_AVAILABILITY_OPTIONS),
    channelFocus: mapByValue(CHANNEL_FOCUS_OPTIONS),
    compensationDisclosure: mapByValue(COMP_DISCLOSURE_OPTIONS),
    employmentType: mapByValue(EMPLOYMENT_TYPE_OPTIONS),
    relationship: mapByValue([...RELATIONSHIP_OPTIONS_JOB, ...RELATIONSHIP_OPTIONS_CANDIDATE]),
    visa: mapByValue([...VISA_POLICY_OPTIONS_JOB, ...VISA_POLICY_OPTIONS_CANDIDATE]),
    workArrangement: mapByValue(WORK_ARRANGEMENT_OPTIONS),
  },
};
